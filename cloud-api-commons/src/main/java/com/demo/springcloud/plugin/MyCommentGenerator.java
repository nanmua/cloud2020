package com.demo.springcloud.plugin;
...
public class MyCommentGenerator extends DefaultCommentGenerator {
    ...
    public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addJavaDocLine("import lombok.AllArgsConstructor;");
        topLevelClass.addJavaDocLine("import lombok.Builder;");
    ...
    /**
     * 添加自定义javadoc标签 此方法为其添加自定义javadoc标记。 如果您不希望包含Javadoc标记，则可能无效 - 但是，如果您不包含Javadoc标记，那么eclipse插件的Java合并功能将会中断。
     *
